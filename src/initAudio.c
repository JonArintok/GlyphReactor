...
void initAudio(void) {
	...
	setOscIncFromFreq  (voice_menuDn, vo_wave, freqFromPitch(60));
	...
	setOscIncFromFreq  (voice_menuSelect, vo_wave, freqFromPitch(64));
	...
	setOscShift        (voice_menuSelect, vo_incMod, 1.0);
